...
public class Esempio {
	...
	public static void main(String[] args) throws IOException, HotelGiaPresenteException{
		...
		s.aggiungiRecensione("20170627","Altra recensione3", "", 2.0, "ginoblu", 2);
		...
		System.out.println("\nNumero di recensioni fornite dall'utente \"gigino\": "+s.calcolaNumeroRecensioniUtente("gigino"));
		...
		System.out.println("Calcolo media recensioni dell'hotel con codice 3: "+s.calcolaMediaVotiRecensioniHotel(3));
		...
		for (Hotel h : s.elencoHotelCittaPerMediaVotiRecensioniDecrescenti("Torino"))
			System.out.println(""+h.getNome()+ " "+h.getIndirizzo()+ " "+h.getCitta()+" "+h.mediaVoti());
