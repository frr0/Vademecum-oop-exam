...
public class GuiCreaListe extends JFrame {
  ...
  public GuiCreaListe(Elezione elezione) {
    ...
    liste.setListData(elezione.liste.keySet().toArray());
    cittadini.setListData(elezione.elettori.keySet().toArray());
  ...
  void doAddCapoLista() {
		...
		String c = (String)cittadini.getSelectedValue();
		String l = (String)liste.getSelectedValue();
	    
		Cittadino cittadino = elezione.getCittadino(c); 
		Lista lista = elezione.getLista(l);
		    
		try {
		   lista.assegnaCapolista(cittadino);
	  ...
	  void doAddCandidato() {
		...
		try {
			lista.aggiungiCandidato(cittadino);
		} catch (CandidatoNonValido e) {
				e.printStackTrace();
		}
	  }
  ...
  void doRegistraLista() {
    // TODO aggiungere gestione pulsante registraLista
	  ...
	  String m = motto.getText();
	  elezione.registraLista(new Lista(n,m));
	  liste.setListData(elezione.liste.keySet().toArray());
